...
plt.plot(a_w_range, np.mean(error_thresh, axis=0) / N_x, marker='o', markerfacecolor='k', label='error thresh')
plt.plot(a_w_range, np.mean(error_omp, axis=0) / N_x, label='error bmp')

plt.plot(a_w_range, np.mean(ay_kwta, axis=0) / N_y, linestyle='--', label=r'$s_y$ kwta')
plt.plot(a_w_range, np.mean(ay_thresh, axis=0) / N_y, linestyle='--', marker='o', markerfacecolor='k', label=r'$s_y$ thresh')
plt.plot(a_w_range, np.mean(ay_omp, axis=0) / N_y, linestyle='--', label=r'$s_y$ bmp')
